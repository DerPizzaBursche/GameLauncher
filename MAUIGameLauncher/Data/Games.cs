                ...
                if (Directory.Exists(path))
                {
                    ...
                    foreach (string gameDir in Directory.GetDirectories(path))
                    {
                        ...
                        if (Directory.EnumerateFiles(gameDir, "*.exe").Any())
                        {
                            ...
                            games.Add(game);
                            //File.AppendAllText("games.json", JsonConvert.SerializeObject(game));
                            //using (StreamWriter f = File.AppendText(""))
                            //{
                            //    JsonSerializer serializer = new JsonSerializer();
                            //    serializer.Serialize(f, game);
                            //}
                        };
                    }
                }
...
//C:\Users\nickr\source\repos\DerPizzaBursche\MAUIGameLauncher\MAUIGameLauncher\Data\games.json